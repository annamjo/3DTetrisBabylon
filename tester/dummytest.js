...
var Gameboardd = /** @class */ (function () {
    ...
    Gameboardd.prototype.create = function () {
    ...
    Gameboardd.prototype.createGrid = function () {
    ...
    Gameboardd.prototype.createPlane = function (x, y, z, rotation) {
    ...
    Object.defineProperty(Gameboardd.prototype, "size", {
        get: function () {
            return this._size;
        },
        enumerable: true,
    ...
    Object.defineProperty(Gameboardd.prototype, "height", {
        get: function () {
            return this._height;
        },
        enumerable: true,
    ...
    Object.defineProperty(Gameboardd.prototype, "ground", {
        get: function () {
            return this._ground;
        },
        enumerable: true,
    ...
    Object.defineProperty(Gameboardd.prototype, "groundlvl", {
        get: function () {
    ...
    //     return this._lplane;
    // }
    Gameboardd.prototype.fillSpaces = function () {
    ...
    Object.defineProperty(Gameboardd.prototype, "spaces", {
        get: function () {
            return this._spaces;
        },
        enumerable: true,
    ...
    Gameboardd.prototype.fillPositions = function () {
    ...
    Object.defineProperty(Gameboardd.prototype, "positions", {
        get: function () {
    ...
    // }
    Gameboardd.prototype.inGrid = function (blockpos) {
        var inBounds;
    ...
    Gameboardd.prototype.canMove = function (blockpos, dir) {
    ...
    Gameboardd.prototype.isOccupied = function (current, potential) {
    ...
    Gameboardd.prototype.updateSpaces = function (position, active, landed) {
...
var Blockd = /** @class */ (function () {
    function Blockd(cubeNum) {
    ...
    Blockd.prototype.createCube = function (ypos, xpos) {
    ...
    Blockd.prototype.createEdges = function (cube) {
        cube.enableEdgesRendering();
        cube.edgesWidth = 5.0;
        cube.edgesColor = new BABYLON.Color4(0, 0, 0, 1); //black edges
        return cube;
    };
    Object.defineProperty(Blockd.prototype, "position", {
        get: function () {
    ...
    Blockd.prototype.rotate = function (axis, rotation) {
    ...
    Blockd.prototype.becomeChild = function (cube /*BABYLON.InstancedMesh*/) {
    ...
    Blockd.prototype.getPositions = function () {
        return this.positions;
    };
    Blockd.prototype.getRelPos = function () {
        return this.positions;
    };
    return Blockd;
}());
var BigTowerd = /** @class */ (function (_super) {
    __extends(BigTowerd, _super);
    ...
    BigTowerd.prototype.create = function () {
    ...
    // }
    BigTowerd.prototype.getPositions = function () {
    ...
    BigTowerd.prototype.setCubes = function () {
        this.cubes = [this._cube2, this._cube3, this._cube4];
    };
    return BigTowerd;
}(Blockd));
var BigCubed = /** @class */ (function (_super) {
    __extends(BigCubed, _super);
    function BigCubed() {
    ...
    BigCubed.prototype.create = function () {
    ...
    //     return this.positions;
    // }
    BigCubed.prototype.getPositions = function () {
        return [this.parentCube.position, this._cube2.getAbsolutePosition(), this._cube3.getAbsolutePosition(), this._cube4.getAbsolutePosition(),
...
var ZBlockd = /** @class */ (function (_super) {
    ...
    ZBlockd.prototype.create = function () {
    ...
    ZBlockd.prototype.getPositions = function () {
        return [this.parentCube.position, this._cube2.getAbsolutePosition(), this._cube3.getAbsolutePosition(), this._cube4.getAbsolutePosition()];
    };
    ZBlockd.prototype.getRelPos = function () {
        this.setPositions();
        return this.positions;
    };
    ZBlockd.prototype.setPositions = function () {
        // this.uncouple();
        this.positions = [this.parentCube.position, this._cube2.position, this._cube3.position, this._cube4.position];
    };
    ZBlockd.prototype.setCubes = function () {
        this.cubes = [this._cube2, this._cube3, this._cube4];
    };
    return ZBlockd;
}(Blockd));
var BigLd = /** @class */ (function (_super) {
    __extends(BigLd, _super);
    function BigLd() {
        var _this = _super.call(this, 4) || this;
        _this.type = "big l";
        _this.create();
    ...
    BigLd.prototype.create = function () {
    ...
    BigLd.prototype.getPositions = function () {
        return [this.parentCube.position, this._cube2.getAbsolutePosition(), this._cube3.getAbsolutePosition(), this._cube4.getAbsolutePosition()];
    };
    BigLd.prototype.getRelPos = function () {
        this.setPositions();
        return this.positions;
    };
    BigLd.prototype.setPositions = function () {
        // this.uncouple();
        this.positions = [this.parentCube.position, this._cube2.position, this._cube3.position, this._cube4.position];
    };
    BigLd.prototype.setCubes = function () {
        this.cubes = [this._cube2, this._cube3, this._cube4];
    };
    return BigLd;
}(Blockd));
var Cubed = /** @class */ (function (_super) {
    __extends(Cubed, _super);
    function Cubed() {
    ...
    Cubed.prototype.create = function () {
    ...
    Cubed.prototype.getPositions = function () {
        this.setPositions();
        return this.positions;
    };
    Cubed.prototype.setPositions = function () {
        // this.positions[0] = this.parentCube.position;
        this.positions = [this.parentCube.position];
    };
    return Cubed;
}(Blockd));
var MiniLd = /** @class */ (function (_super) {
    __extends(MiniLd, _super);
    function MiniLd() {
    ...
    MiniLd.prototype.create = function () {
...
var ShortTowerd = /** @class */ (function (_super) {
    ...
    ShortTowerd.prototype.create = function () {
        this.parentCube = this.createCube(6.5, 0);
        var mat = new BABYLON.StandardMaterial("mat", scene);
    ...
    ShortTowerd.prototype.getPositions = function () {
        return [this.parentCube.position, this._cube2.getAbsolutePosition(), this._cube3.getAbsolutePosition()];
    };
    ShortTowerd.prototype.getRelPos = function () {
        this.setPositions();
        return this.positions;
    };
    ShortTowerd.prototype.setPositions = function () {
    ...
    ShortTowerd.prototype.setCubes = function () {
        this.cubes = [this._cube2, this._cube3];
    };
    return ShortTowerd;
}(Blockd));
var TBlockd = /** @class */ (function (_super) {
    __extends(TBlockd, _super);
    function TBlockd() {
        var _this = _super.call(this, 4) || this;
        _this.type = "t block";
        _this.create();
    ...
    TBlockd.prototype.create = function () {
    ...
    TBlockd.prototype.getPositions = function () {
        return [this.parentCube.position, this._cube2.getAbsolutePosition(), this._cube3.getAbsolutePosition(), this._cube4.getAbsolutePosition()];
    };
    TBlockd.prototype.getRelPos = function () {
        this.setPositions();
        return this.positions;
    };
    TBlockd.prototype.setPositions = function () {
        // this.uncouple();
        this.positions = [this.parentCube.position, this._cube2.position, this._cube3.position, this._cube4.position];
    };
    TBlockd.prototype.setCubes = function () {
        this.cubes = [this._cube2, this._cube3, this._cube4];
    };
    return TBlockd;
}(Blockd));
var Gamed = /** @class */ (function () {
    function Gamed(size, scene) {
        var _this = this;
        this.scene = scene;
    ...
    Gamed.prototype.drawBlock = function () {
    ...
    //     return false;
    // }
    Gamed.prototype.fixRotationOffset = function () {
    ...
    Gamed.prototype.checkCollision = function () {
    ...
    Gamed.prototype.setLanded = function () {
    ...
    Gamed.prototype.checkFullLayer = function () {
    ...
    Gamed.prototype.clearLayer = function (layer, layerheight, size) {
    ...
    Gamed.prototype.collapseLayers = function (layerNums, size, height) {
    ...
    Gamed.prototype.enableControls = function () {
    ...
    Gamed.prototype.isGameOver = function () {
