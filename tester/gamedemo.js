...
var Blockb = /** @class */ (function () {
    ...
    Blockb.prototype.getRelPos = function () {
        return this.positions;
    };
    return Blockb;
}());
var BigTowerb = /** @class */ (function (_super) {
    ...
    BigTowerb.prototype.getRelPos = function () {
        this.setPositions();
...
var BigCubeb = /** @class */ (function (_super) {
    ...
    BigCubeb.prototype.getRelPos = function () {
        this.setPositions();
        return this.positions; //gives relative positions (because cubes still parented), except cant get rel pos of parent cube...
    };
...
var ZBlockb = /** @class */ (function (_super) {
    ...
    ZBlockb.prototype.getRelPos = function () {
        this.setPositions();
        return this.positions;
    };
...
var BigLb = /** @class */ (function (_super) {
    ...
    BigLb.prototype.getRelPos = function () {
        this.setPositions();
        return this.positions;
    };
...
var MiniLb = /** @class */ (function (_super) {
    ...
    MiniLb.prototype.getRelPos = function () {
        this.setPositions();
        return this.positions;
    };
...
var ShortTowerb = /** @class */ (function (_super) {
    ...
    ShortTowerb.prototype.getRelPos = function () {
        this.setPositions();
        return this.positions;
    };
...
var TBlockb = /** @class */ (function (_super) {
    ...
    TBlockb.prototype.getRelPos = function () {
        this.setPositions();
        return this.positions;
    };
